...
public class LdwBasketUserInformation implements Serializable{
    private Long id;
    ...
    public void setSocialUniformCreditCode(String socialUniformCreditCode) {
        this.socialUniformCreditCode = socialUniformCreditCode == null ? null : socialUniformCreditCode.trim();
    }
